...
def args_parser():
    ...
    parser.add_argument('--alpha', default=0.5, type=float, help='the degree of non-IID-ness')


    parser.add_argument('--lr_reduce', default=10, type=int, help='reduction factor for learning rate')
    parser.add_argument('--timesteps', default=16, type=int, help='simulation timesteps')
    ...
    parser.add_argument('--trigger_size', type=float, default=0.3, help="size of the trigger")
    parser.add_argument('--polarity', type=int, default=3, help="polarity of the trigger")
    parser.add_argument('--pos', type=str, default='top-left', help="position of the trigger")
    ...
    parser.add_argument('--split',  type=int, default=None, help="number of splits for the attack")
    ...
    parser.add_argument('--cupy', action='store_true', help="Whether to use cupy for faster computation")
